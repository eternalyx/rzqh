...
public interface SysDeptLeaderRepository extends JpaRepository<SysDeptLeader, String>, JpaSpecificationExecutor<SysDeptLeader> {
    ...
    List<SysDeptLeader> findLeaderByDeptId(String deptId);
     ...
     * @return /
     */
    List<SysDeptLeader> findByUserId(String userId);
}
