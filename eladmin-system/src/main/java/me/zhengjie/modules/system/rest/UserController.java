...
public class UserController {
    ...
    public void export(HttpServletResponse response, UserQueryCriteria criteria) throws IOException {
    ...
    public ResponseEntity<Object> create(@Validated @RequestBody User resources) {
        ...
        // 传递密码为空,则使用默认密码 123456
        resources.setPassword(passwordEncoder.encode(StringUtils.isEmpty(resources.getPassword()) ? "123456" : resources.getPassword()));
